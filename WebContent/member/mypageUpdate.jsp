					...
					<table>
						...
						<tr>
							...
							<td><input type="checkbox" name="user_interest" id="농구"
								value="농구">농구 <input type="checkbox"
								name="user_interest" value="배구">배구 <input
								...
								<input type="checkbox" name="user_interest" value="풋살">풋살</td>
						</tr>
					</table>
					<input type="hidden" id="user_id" name="user_id"
						value="${member.user_id }"> <input type="submit"
						value="수정하기">
				</form>
			</div>
		</div>
