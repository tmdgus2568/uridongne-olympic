		...
		<div>
			<table class="table table-hover" id="mypage">
				...
				<tfoot>
					<tr>
						<th colspan="2"
							style="border-bottom: none; text-align: right; padding-top: 14px; font-family: NanumSquareRound;"><button
								type="button" class="btn btn-primary"
								onclick="location.href='update'">회원정보 수정</button></th>
					</tr>
				</tfoot>
			</table>
		</div>
