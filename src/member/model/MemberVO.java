...
public class MemberVO {
	...
	public MemberVO(String user_id, String user_pw, String user_name, Date user_birth, String user_email, int user_phone,
	...
	public String toString() {
		return "MemberVO [user_id=" + user_id + ", user_pw=" + user_pw + ", user_name=" + user_name + ", user_birth="
